                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <x-auth.input-field type="text" name="title" id="title" place="Enter role title"
                                val="{{ old('title', $data->title) }}" required="true" label="Role Title" />
                        </div>

                        <div class="col-md-6">
                            <x-auth.input-field type="color" name="color" id="color" val="{{ old('color', $data->color) }}"
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="alert alert-info px-2">
                                Use the Assign Permissions button on the role detail page to manage permissions for this role.
                            </div>
                        </div>
