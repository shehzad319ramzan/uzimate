<x-layouts.auth>
    <x-slot name="pageTitle">Create Site</x-slot>
    <x-auth.card card-header="Create Site" header-button="true">
        <x-slot name="headerCustom">
            <x-auth.href-link link-href="{{ route('sites.index') }}" link-value="{{ __('Back to List') }}"
                link-class="btn btn-outline-primary me-2" />
        </x-slot>
        <x-auth.form form-action="{{ route('sites.store') }}" enctype="true">
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="use_merchant_logo" id="use_merchant_logo" value="1" {{ old('use_merchant_logo') ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    <x-auth.input-field type="text" name="name" id="name" required="true"
                        place="Enter site name" val="{{ old('name') }}" extraclasses="mb-3"
                        label="Name" />
                </div>
                <!-- Right Column -->
                <div class="col-md-6">
                    <x-auth.input-field type="tel" name="phone" id="phone" required="true"
                        place="Enter phone number" val="{{ old('phone') }}" extraclasses="mb-3"
                        label="Phone" />
                </div>
                ...
                <div class="col-md-6">
                    <x-auth.input-field type="number" name="points" id="points" required="true"
                        place="Enter points" val="{{ old('points') }}" extraclasses="mb-3"
                        label="Points" />
                </div>
                <!-- Right Column -->
                <div class="col-md-6">
                    <x-auth.input-field type="time" name="start_time" id="start_time"
                        place="" val="{{ old('start_time') }}" extraclasses="mb-3"
                        label="Start Time" />
                </div>
                ...
                <div class="col-md-6">
                    <x-auth.input-field type="time" name="closed_time" id="closed_time"
                        place="" val="{{ old('closed_time') }}" extraclasses="mb-3"
                        label="Closed Time" />
                </div>
                <!-- Right Column -->
                <div class="col-md-6">
                    <x-auth.input-field type="text" name="address_line_1" id="address_line_1" required="true"
                        place="Enter address line 1" val="{{ old('address_line_1') }}" extraclasses="mb-3"
                ...
                <div class="col-md-6">
                    <x-auth.input-field type="text" name="address_line_2" id="address_line_2"
                        place="Enter address line 2" val="{{ old('address_line_2') }}" extraclasses="mb-3"
                        label="Address Line 2" />
                </div>
                <!-- Right Column -->
                <div class="col-md-6">
                    <x-auth.input-field type="text" name="city" id="city" required="true"
                        place="Enter city" val="{{ old('city') }}" extraclasses="mb-3"
                        label="City" />
                </div>
                ...
                <div class="col-md-6">
                    <x-auth.input-field type="text" name="county" id="county"
                        place="Enter county" val="{{ old('county') }}" extraclasses="mb-3"
                        label="County" />
                </div>
                <!-- Right Column -->
                <div class="col-md-6">
                    <x-auth.input-field type="text" name="postcode" id="postcode" required="true"
                        place="Enter postcode" val="{{ old('postcode') }}" extraclasses="mb-3"
                        label="Postcode" />
                </div>
                ...
                <div class="col-md-6">
                    <x-auth.input-field type="text" name="country" id="country"
                        place="Enter country" val="{{ old('country', 'United Kingdom') }}" extraclasses="mb-3"
                        label="Country" />
                </div>
                <!-- Right Column -->
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select" name="location" id="location">
                            ...
                            <option value="1" {{ old('location') == '1' ? 'selected' : '' }}>Location 1</option>
                            <option value="2" {{ old('location') == '2' ? 'selected' : '' }}>Location 2</option>
                        </select>
                    </div>
                </div>
